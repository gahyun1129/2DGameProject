...
class GameInfoUI:
    ...
    def draw(self):
        ...
        self.ball_count_image.clip_draw(server.gameMgr.cur_hitter.ball * 60, 0, 60, 15, 88, 515)
        self.strike_count_image.clip_draw(server.gameMgr.cur_hitter.strike * 40, 0, 40, 15, 95, 500)
        self.out_count_image.clip_draw(server.gameMgr.out_count * 40, 0, 40, 15, 148, 500)

        self.font.draw(260, 560, f'{server.gameMgr.user_score}', (255, 255, 255))
        self.font.draw(260, 530, f'{server.gameMgr.com_score}', (255, 255, 255))
